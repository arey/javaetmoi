...
featureImage: word-image-2335-1.jpeg
...
summary: |-
  ...
  ![word-image-2335-1](/2024/04/la-doc-va-bien-ne-ten-fais-pas/word-image-2335-1.jpeg)
tags:
  - arc42
  - asciidoc
  - c4
...
![Interface ReDoc pour la documentation d'une API REST OpenAPI dans IntelliJ](word-image-2335-2.png)
...
![Diagramme de contexte C4 créé avec C4-PlantUML](word-image-2335-3.png)
...
![Tableau des décisions architecturales avec liens vers les études associées](word-image-2335-4.png)
...
![Niveaux d'abstraction du modèle C4 : Contexte, Conteneurs, Composants, Code](word-image-2335-5.png)
...
![Diagramme d'architecture logicielle créé avec Structurizr DSL](word-image-2335-6.png)
...
![Capture d'écran de Compodoc pour la documentation d'une application Angular](word-image-2335-7.png)
...
![sequence achat billet](sequence-achat-billet.png)
...
![Zoom sur la table Track et ses relations au 2ème degré dans l'outil de documentation de base de données](word-image-2335-9.png)
...
Damien cite les **annotations Java** de Cyrille Martraire permettant d’extraire le glossaire et dont je vous avais [déjà parlé en 2016](Devoxx_France-2016-Live_documentation.pdf).
...
![Schéma des 4 types de documentation : tutoriel, how-to, concepts, référence](word-image-2335-10.png)  
