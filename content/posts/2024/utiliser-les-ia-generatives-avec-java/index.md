...
featureImage: devoxx-france-2024-banniere-generative-ai-avec-java.png
...
summary: |-
  ...
  **Abdel** est Developer Advocate chez Google<br>Expert en Kubernetes, il travaille notamment sur le déploiement des solutions d’IA sur k8s.
  ![devoxx-france-2024-banniere-generative-ai-avec-java](/2024/04/utiliser-les-ia-generatives-avec-java/devoxx-france-2024-banniere-generative-ai-avec-java.png)
tags:
  - cassandra
  - devoxx
  - embedding
...
Expert en Kubernetes, il travaille notamment sur le déploiement des solutions d’IA sur k8s.![Cédrick et Abdel présentant l'IA générative avec Java à Devoxx France 2024](word-image-2270-1.png)  
...
![LLM référencés sur lifearchitect.ai](word-image-2270-2.png "LLM référencés sur lifearchitect.ai")
...
![Offres de Google Vertex AI](word-image-2270-3.png "Offres de Google Vertex AI")
...
![Using Vertex AI in Java](word-image-2270-4.png "Using Vertex AI in Java")
...
![Gemini 1.5](word-image-2270-5.png "Gemini 1.5")
...
![Screenshot Démo de Gemini sur https://gemini.google.com/app](word-image-2270-6.png "Screenshot Démo de Gemini sur https://gemini.google.com/app")
...
![LLM supportés par Langchain4j en 2024](word-image-2270-7.png "LLM supportés par Langchain4j en 2024")
...
![Bonnes pratiques de prompt engineering](word-image-2270-8.png "Bonnes pratiques de prompt engineering")
...
![Paramètres de configuration d’un LLM](word-image-2270-9.png "Paramètres de configuration d’un LLM")
...
![Few-Shot Learning](word-image-2270-10.png "Few-Shot Learning")

**Chain of Thoughts**

Chaine de pensée : donner un raisonnement pour que le LLM trouve le résultat.

![Cgain of Thoughts](word-image-2270-11.png "Cgain of Thoughts")
...
![CoT + Self consistency](word-image-2270-12.png "CoT + Self consistency")
...
![Illustration du stockage de données dans une base vectorielle](word-image-2270-13.png)  
...
![Slide illustrant les méthodes de calcul de distance entre vecteurs](word-image-2270-14.png)
...
![Représentation mathématique de la cosine similarity sur la sphère unité](word-image-2270-15.png)
...
![Schéma du pipeline de preprocessing pour la vectorisation de documents](word-image-2270-16.png)
