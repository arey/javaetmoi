...
![Dépendances Spring Initializr proposées depuis IntelliJ IDEA](image-1.png)
...
![Fichier hello.http généré par TestOpenApiContributor pour tester l'API REST depuis IntelliJ](image-2.png)
