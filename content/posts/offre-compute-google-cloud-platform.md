...
1. **Snapchat**: son backend est sous App Engine. En 2015, sur 20 personnes, ils n’ont aucun Ops. Techniquement, ce sont les les Ops de Google. Aujourd’hui, Snapchat dépasse Twiter en nombre d’utilisateurs.
