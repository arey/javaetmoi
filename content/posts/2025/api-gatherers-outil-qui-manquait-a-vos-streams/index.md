...
featureImage: word-image-2551-1-edited.jpeg
usePageBundles: true
footnotes: ""
...
summary: |-
  ...
  **Java Developer Advocate** chez Oracle, **José Paumard** nous présente la nouvelle [**API Gatherers**](https://docs.oracle.com/en/java/javase/24/core/stream-gatherers.html) qui, depuis Java 24, vient se greffer sur l’ **API Stream** Java sortie il y’a 11 ans avec Java 8.
  ...
  ![L’API Gatherers : l’outil qui manquait à vos Streams](/2025/04/api-gatherers-outil-qui-manquait-a-vos-streams/word-image-2551-1-edited.jpeg)
tags:
  - devoxx
  - java
...
![Diagramme illustrant le Combiner de l'API Gatherer pour les Streams Java parallèles](word-image-2551-2.png)
...
![Illustration du Sequential Gatherer dans l'API Java Streams](word-image-2551-3.png)
