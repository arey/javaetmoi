...
featureImage: word-image-2508-1.jpeg
usePageBundles: true
footnotes: ""
...
![Diagramme de contexte C4 du système](word-image-2508-2.png)

[Diagramme de contexte C4](https://c4model.com/diagrams/system-context) correspondant :

![Diagramme de contexte C4 de l'application](word-image-2508-3.png)
...
![Quality Attributes Clusters](word-image-2508-4.png)  
...
![Modular monolith](word-image-2508-5.png)

L’architecture se pense à différents niveaux, à plusieurs.   
![Architectural perspectives](word-image-2508-6.png)  
...
![Integration options between modules 1](word-image-2508-7.png)
...
![Solution 1 : mono instance avec multi-threading pour résoudre le goulot d'étranglement](word-image-2508-10.png)  
...
![Solution 2 : multi-instance avec architecture pub-sub](word-image-2508-11.png)  
...
![Solution 3 (non retenue) : combinaison de multi-thread et multi-instance](word-image-2508-12.png)
...
![Schéma de la migration du modular monolith vers l'architecture microservices](word-image-2508-13.png)  
...
![Pubsub architecture tradeoffs](word-image-2508-14.png)
...
![Schéma du déploiement d'un mock en production pour validation rapide des hypothèses](word-image-2508-15.png)  
...
![Contrat JSON entre les services dispatcher et aggregator](word-image-2508-16.png)

Un renommage serait possible mais il est recommandé de positionner 2 champs pour respecter le contrat.

![Exemple de contrat JSON avec champ renommé et champ de compatibilité ascendante](word-image-2508-17.png)  
...
![Liste des outils recommandés : ADR et ArchUnit pour les décisions architecturales](word-image-2508-18.png)
...
![3 livres recommandés par Cyrille Martraire](word-image-2508-19.png)
