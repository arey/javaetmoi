...
featureImage: word-image-2482-1.jpeg
...
summary: |-
  ...
  ![Sébastien Deleuze at Devoxx France 2025](/2025/04/optimisez-vos-applications-spring-boot-avec-cds-et-le-projet-leyden/word-image-2482-1.jpeg)
tags:
  - devoxx
  - spring-boot
  - spring-framework
...
![Training run workflow](word-image-2482-2.png)
...
![java -Dspring.context.exit=onRefresh](word-image-2482-3.png)
...
![CDS file layout](cds-file-layout.png)
...
![Training run configuration for your database](word-image-2482-5.png)
...
![CDS support in Buildpacks](word-image-2482-6.png)
...
![AOT Cache and Spring AOT are different but they combine well](word-image-2482-7.png)
...
![Spring Petclinic startup time (seconds)](word-image-2482-8.png)
...
![Spring Petclinic startup time (secondes)](word-image-2482-9.png)

![Warmup with and without AOT cache](word-image-2482-10.png)
...
![Comparing GraalVM, Project CRaC and AOT cache](word-image-2482-11.png)
