...
toc: true
thumbnail: architecture-middle-indexation.png
featureImage: architecture-middle-indexation.png
...
![Chaque mise à jour d’une entité métier implique une opération d’indexation atomique.](architecture-middle-indexation.png)
...
![Intercepteur positionné par un post-processeur de beans Spring](intercepteur-spring-notification.png)
