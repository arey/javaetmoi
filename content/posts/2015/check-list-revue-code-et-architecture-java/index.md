...
featureImage: clean_code_72_color.png
...
summary: |-
  [![clean_code_logo](/2015/08/check-list-revue-code-et-architecture-java/clean_code_72_color.png)](clean_code_72_color.png) Réaliser des **revues de code e** st une activité que je pratique régulièrement sur les projets que j’encadre techniquement. De manière général, elles **se déroulent sur le poste du développeur**. Ce dernier me présente ses derniers changements, justifie ses choix et m’explique ses difficultés. En fonction de son expérience sur le projet, la périodicité des revues varie d’1 fois par jour à 2 fois par mois.
  ...
  ![clean_code_logo](/2015/08/check-list-revue-code-et-architecture-java/clean_code_72_color.png)
title: Check-list revue de code Java
url: /2015/08/check-list-revue-code-et-architecture-java/

---
[![clean_code_logo](clean_code_72_color.png)](clean_code_72_color.png) Réaliser des **revues de code e** st une activité que je pratique régulièrement sur les projets que j’encadre techniquement. De manière général, elles **se déroulent sur le poste du développeur**. Ce dernier me présente ses derniers changements, justifie ses choix et m’explique ses difficultés. En fonction de son expérience sur le projet, la périodicité des revues varie d’1 fois par jour à 2 fois par mois.
Les améliorations à apporter sont réalisées en séance en pair programming ou bien consignées directement dans le code à l’aide d’un TODO. Je profite de ces moments privilégiés pour expliquer et/ou échanger autour des règles de coding et d’architecture logicielle.
