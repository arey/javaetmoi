...
toc: true
thumbnail: angular-musicbrainz-screenshot.png
featureImage: angular-musicbrainz-screenshot.png
...
summary: |-
  ...
  ![Angular MusicBrainz web app screenshot](/2014/02/developper-industrialiser-web-app-recherche-angularjs/angular-musicbrainz-screenshot.png)
tags:
  - angularjs
  - bootstrap
  - bower
...
![Angular MusicBrainz web app screenshot](angular-musicbrainz-screenshot.png)
...
**Nom du filtre****Utilisation****Rendu****interpolate**{ 'v%VERSION%' \| interpolate }V1.0**joinBy**{{hit.\_source.tags \| joinBy:' - '}}pop - rock - blues**reverse**ng-repeat="rating in facets.rating.entries \| reverse"[![angular-musicbrainz-rating](angular-musicbrainz-rating.png)](angular-musicbrainz-rating.png)**artistTypeLabel**{{type.term \| artistTypeLabel}}Artiste (fr) ou Artist (en)**yearFormat**{{range \| yearFormat}}Avant 1970 (fr)
...
**Directive****Utilisation****Rendu****Cover**<cover album-id="hit.\_source.id"> </cover>[![angular-musicbrainz-cover](angular-musicbrainz-cover.png)](angular-musicbrainz-cover.png)**Rank**<rank score="hit.\_source.rating.score"> </rank>[![angular-musicbrainz-rank](angular-musicbrainz-rank1.png)](angular-musicbrainz-rank1.png)
...
DirectiveVisuelExemple d’utilisation dans les templates HTML**typeahead**[![angular-musicbrainz-typeahead](angular-musicbrainz-typeahead.png)](angular-musicbrainz-typeahead.png)
...
**pagination**[![angular-musicbrainz-pagination](angular-musicbrainz-pagination.png)](angular-musicbrainz-pagination.png)
...
**pager**[![angular-musicbrainz-pager](angular-musicbrainz-pager.png)](angular-musicbrainz-pager.png)
...
![angular-musicbrainz-e2e](angular-musicbrainz-e2e.png)
...
![angular-musicbrainz-jshint](angular-musicbrainz-jshint.png)

![angular-musicbrainz-jshint2](angular-musicbrainz-jshint2.png)
...
![angular-musicbrainz-travis](angular-musicbrainz-travis.png)
...
![angular-musicbrainz-coveralls1](angular-musicbrainz-coveralls1.png)
...
![angular-musicbrainz-david](angular-musicbrainz-david.png)
...
## [![angular-musicbrainz-build-status](angular-musicbrainz-build-status.png)](angular-musicbrainz-build-status.png)  
Conclusion
