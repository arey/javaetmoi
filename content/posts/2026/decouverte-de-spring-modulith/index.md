...
categories:
  - retour-d'expérience
  - spring
thumbnail: logo-spring-modulith.png
featureImage: banner-spring-petclinic-modulith.png
...
summary: |-
  ...
  ![Bannière Spring PetClinic Modulith](/2026/04/decouverte-de-spring-modulith/banner-spring-petclinic-modulith.png)
tags:
  - spring-boot
  - spring-modulith
  - spring-petclinic
...
![Illustre le découpage en modules de l'application Spring Modulith à l'aide de Spring Modulith](illustration-spring-petclinic-modulith-v2.png)
...
![Table de correspondance modules Spring Modulith et packages Java dans Spring Petclinic](word-image-2642-1.png)
...
![Structure du projet Spring Petclinic après suppression du package model partagé](word-image-2642-2.png)
...
![Organisation du module owner en packages ui, application et domain](word-image-2642-3.png)
...
![Screenshot of the Veterinarians menu of the Spring Modulith version of Spring Petclinic](screenshot-spring-petclinic-modulith.png)
...
![Diagramme PlantUML du module vet généré par Spring Modulith](word-image-2642-4.png)



Exemple de rendu du fichier `module-vet.adoc `:   
![Documentation AsciiDoc du module vet générée par Spring Modulith](word-image-2642-5.png)
