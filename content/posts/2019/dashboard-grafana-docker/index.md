...
Les métriques préfixées par `petclinic_` sont accessibles depuis l’interface web de Prometheus [http://localhost:9091/](http://localhost:9091/) :

![Prometheus UI](2019-03-Dashboard-Grafana-dockerisé-prometheus.png)
